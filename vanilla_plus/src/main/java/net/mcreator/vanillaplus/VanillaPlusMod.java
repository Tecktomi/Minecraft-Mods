package net.mcreator.vanillaplus;
...
import net.mcreator.vanillaplus.init.VanillaPlusModTabs;
...
import net.mcreator.vanillaplus.init.VanillaPlusModBlockEntities;
...
public class VanillaPlusMod {
	public static final Logger LOGGER = LogManager.getLogger(VanillaPlusMod.class);
	public static final String MODID = "vanilla_plus";

	public VanillaPlusMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);
		VanillaPlusModBlocks.REGISTRY.register(modEventBus);
		VanillaPlusModBlockEntities.REGISTRY.register(modEventBus);
		VanillaPlusModItems.REGISTRY.register(modEventBus);
		VanillaPlusModTabs.REGISTRY.register(modEventBus);
		VanillaPlusModMenus.REGISTRY.register(modEventBus);
