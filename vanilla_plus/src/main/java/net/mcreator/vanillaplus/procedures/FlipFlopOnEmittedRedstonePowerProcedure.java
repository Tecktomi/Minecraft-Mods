...
public class FlipFlopOnEmittedRedstonePowerProcedure {
	public static double execute(BlockState blockstate, Direction direction) {
		if (direction == null)
			return 0;
		if ((direction.getOpposite()) == (getDirectionFromBlockState(blockstate))) {
			return 15;
		}
		return 0;
	}
