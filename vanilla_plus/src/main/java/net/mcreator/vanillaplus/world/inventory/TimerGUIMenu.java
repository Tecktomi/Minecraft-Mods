...
public class TimerGUIMenu extends AbstractContainerMenu implements VanillaPlusModMenus.MenuAccessor {
	...
	public TimerGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(VanillaPlusModMenus.TIMER_GUI.get(), id);
