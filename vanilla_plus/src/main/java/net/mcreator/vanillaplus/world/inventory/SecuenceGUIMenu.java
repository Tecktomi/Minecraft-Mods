...
public class SecuenceGUIMenu extends AbstractContainerMenu implements VanillaPlusModMenus.MenuAccessor {
	...
	public SecuenceGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(VanillaPlusModMenus.SECUENCE_GUI.get(), id);
